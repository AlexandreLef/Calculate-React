...
class OtherButton extends React.Component<OtherProps> {
    ...
    render() {
        ...
        if (this.props.value === "AC") {
            ...
            return (
                <div className="col-3 p-1">
                    <button className="btn btn-dark text-warning col-12 " onClick={this.sendOther.bind(this)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear-fill" viewBox="0 0 16 16">
